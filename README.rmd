...
### Data cleaning 
I merged all 12 files to one and saved it as a new file in the folder "output-data". The original files are in "raw-data".
...
* The most popular bike type in general are classic bikes, but the percentage is greater in annual members. Maybe annual members are more sportive, maybe they rather choose the classic bike because it is cheaper, or they pick classic bikes because they go on shorter rides. There could be many different reasons.
